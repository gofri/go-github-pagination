package pagination_response_test
...
type linkTestSample struct {
	...
	Links           map[pagination_response.RelType]string
...
func (l linkTestSample) Test(t *testing.T) {
	t.Run(l.Title, func(t *testing.T) {
		...
		parser := pagination_response.NewParser()
...
var responseLinks = []linkTestSample{
	{
		...
		Links: map[pagination_response.RelType]string{
			pagination_response.RelTypeNext: `https://api.github.com/example?page=2`,
		},
	...
	},
	{
		...
		EndpointExample: `https://docs.github.com/en/rest/repos/repos?apiVersion=2022-11-28#list-organization-repositories`,
		Links: map[pagination_response.RelType]string{
			pagination_response.RelTypePrev: `https://api.github.com/example?page=1`,
		},
		Expected: nil,
	},
	{
		...
		EndpointExample: `https://docs.github.com/en/rest/repos/repos?apiVersion=2022-11-28#list-organization-repositories`,
		Links: map[pagination_response.RelType]string{
			pagination_response.RelTypeNext: `https://api.github.com/example?page=3`,
			pagination_response.RelTypePrev: `https://api.github.com/example?page=1`,
		},
	...
	},
	{
		...
		Links: map[pagination_response.RelType]string{
			pagination_response.RelTypeNext: `https://api.github.com/example?page=ABC`,
		},
	...
	},
	{
		...
		Links: map[pagination_response.RelType]string{
			pagination_response.RelTypeNext: `https://api.github.com/example?cursor=ABC`,
		},
	...
	},
	{
		...
		EndpointExample: `https://docs.github.com/en/rest/orgs/webhooks?apiVersion=2022-11-28#list-deliveries-for-an-organization-webhook`,
		Links: map[pagination_response.RelType]string{
			pagination_response.RelTypePrev: `https://api.github.com/example?cursor=ABC`,
		},
		Expected: nil,
	},
	{
		...
		Links: map[pagination_response.RelType]string{
			pagination_response.RelTypeNext: `https://api.github.com/example?cursor=ABC`,
			pagination_response.RelTypePrev: `https://api.github.com/example?cursor=DEF`,
		},
		Expected: map[string]string{`cursor`: `ABC`},
	},
	{
		...
		Links: map[pagination_response.RelType]string{
			pagination_response.RelTypeNext: `https://api.github.com/example?after=ABC`,
		},
	...
	},
	{
		...
		EndpointExample: `https://docs.github.com/en/enterprise-cloud@latest/rest/orgs/orgs?apiVersion=2022-11-28#get-the-audit-log-for-an-organization`,
		Links: map[pagination_response.RelType]string{
			pagination_response.RelTypePrev: `https://api.github.com/example?before=ABC`,
		},
		Expected: nil,
	},
	{
	...
	},
	{
		...
		Links: map[pagination_response.RelType]string{
			pagination_response.RelTypeNext: `https://api.github.com/example?page=5&after=ABC`,
			pagination_response.RelTypePrev: `https://api.github.com/example?before=ABC`,
		},
		Expected: map[string]string{`after`: `ABC`},
	},
	{
		...
		Links: map[pagination_response.RelType]string{
			pagination_response.RelTypeNext: `https://api.github.com/example?since=ABC`,
		},
	...
	},
	{
		...
		Links: map[pagination_response.RelType]string{
			pagination_response.RelTypeNext: `https://api.github.com/example?page=10&since=ABC`,
		},
